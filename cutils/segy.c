...
static const char __pyx_k_C_Users_Utilisateur_PycharmProje[] = "C:\\Users\\Utilisateur\\PycharmProjects\\BhTomoPy\\cutils\\segy.pyx";
 ...
 */
  ...
  __pyx_codeobj__14 = (PyObject*)__Pyx_PyCode_New(5, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_Utilisateur_PycharmProje, __pyx_n_s_read_segy, 207, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__14)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
