...
static const char __pyx_k_C_Users_simonje_Documents_GitHub[] = "C:\\Users\\simonje\\Documents\\GitHub\\BhTomoPy\\cutils\\segy.pyx";
 ...
 */
  ...
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(5, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_simonje_Documents_GitHub, __pyx_n_s_read_segy, 207, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init segy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
